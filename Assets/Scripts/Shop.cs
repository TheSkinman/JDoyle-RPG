    ...
    public void OpenBuyMenu()
    {
        ...
        for (int i = 0; i < buyItemButtons.Length; i++)
        {
            ...
            if (itemsForSell[i] != "")
            {
                ...
                buyItemButtons[i].buttonImage.sprite = GameManager.instance.GetItemDetails(itemsForSell[i]).itemSprite;
...
public void SelectSellItem(Item sellItem)
    ...
    public void SellItem()
    {
        ...
        if (selectedItem && !GameManager.instance.HasItem(selectedItem.itemName))
        {
            SelectSellItem(null);
        }
